...
class ProjectNotifier extends StreamNotifier<List<Project>> {
  ...
  Future<void> addbolsista(String projetoId, String uidBolsista) async{
    await projectsCollection.doc(projetoId).update({
      'bolsista':FieldValue.arrayUnion([uidBolsista]),
    });
  }
